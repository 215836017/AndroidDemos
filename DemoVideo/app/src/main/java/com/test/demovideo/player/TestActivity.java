...
public class TestActivity extends Activity implements SurfaceHolder.Callback, PreviewCallback {

    private final String tag = "TestActivity.java";
...
//    int framerate = 10;
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        startcamera(camera);
        avcCodec = new AvcEncoder(width, height);
